...
[English version](2026-09-16-desktop-runtime.md)

> **已完成的历史计划（2026-09-16）**：本文记录 Desktop runtime 实施步骤；实现已合并到 `main`。当前架构和发布操作以 [架构说明](../../architecture_zh.md) 与 [发布说明](../../desktop-release_zh.md) 为准，本文不作为未完成任务清单。
